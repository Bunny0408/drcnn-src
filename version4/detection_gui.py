...
def query_for_db(pname, gender, result):
    with connection.cursor() as cursor:
        # Insert input text and result into the database
        sql = "INSERT INTO records (pname, gender, result) VALUES (%s, %s, %s)"
        cursor.execute(sql, (pname, gender, result))
        connection.commit()
...
def both_functions():
    ...
    query_for_db(pname_val, gender_val, result)
