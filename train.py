...
with neptune.create_experiment(name='DR_RESNET50', params= PARAMS):
...
with open("ResNet50_SEG_E50.json", "w") as json_file:
    json_file.write(new_modelJson)
base_model.save_weights("ResNet50_SEG_E50.h5")
